...
public class MissileFire : MissilePositionLaunch
{
    ...
    {
        public MissileGenerate loadedMissile;

        MissileGenerate prefab;
        ...
        public HardpointStation(float reloadTime, MissileGenerate missilePrefab, Transform launchPoint, Transform ownShip)
        {
        ...
        /// <returns></returns>
        private MissileGenerate CreateMissile(Transform newParent)
        {
            MissileGenerate mis = Instantiate(prefab, newParent);
            mis.ownShip = ownShip;
