...
[RequireComponent(typeof(MissileGenerate))]
public class MissileEffect : MonoBehaviour
{
    ...
    MissileGenerate missile;
    RemoveEffect effectRemover;
    ...
    private void Awake()
    {
        ...
        missile = GetComponent<MissileGenerate>();
    ...
    private void Start()
    {
        ...
        if (trailPrefab != null || particleTrailPrefab != null)
        {
            ...
            if (particleTrailPrefab != null)
            {
                ...
                if (particleTrail.GetComponent<RemoveEffect>() == null)
                    effectRemover = particleTrail.gameObject.AddComponent<RemoveEffect>();
            }
        }
    }
    ...
    public void Explode()
    {
        ...
        if (explosionFXPrefab != null)
        {
            ...
            if (remove == null)
                remove = explode.gameObject.AddComponent<RemoveEffect>();
